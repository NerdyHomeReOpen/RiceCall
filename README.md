...
DOCS_BASE_URL=https://your-host # Base URL of the static files server
I18N_BASE_URL=https://your-host # Base URL of the static i18n server, files are fetched from {I18N_BASE_URL}/{lng}/{ns}.json
