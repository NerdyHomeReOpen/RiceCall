...
const WebRTCProvider = ({ children }: WebRTCProviderProps) => {
  ...
  const { takeMic, releaseMic, muteUser, unmuteUser, changeBitrate } = useSFUTransport(refs, { initAudioContext, initSpeakerAudio, removeSpeakerAudio, startSpeaking, stopSpeaking });
