...
export const channelsSlice = createSlice({
  ...
  initialState,
  reducers: {
    setChannels: (state, action: PayloadAction<Types.Channel[]>) => {
      state.data = action.payload;
    },
    addChannels: (state, action: PayloadAction<{ data: Types.Channel }[]>) => {
    ...
    updateChannels: (state, action: PayloadAction<{ channelId: string; update: Partial<Types.Channel> }[]>) => {
