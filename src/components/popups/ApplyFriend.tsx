...
interface ApplyFriendPopupProps {
  ...
  receivedFriendApplication: FriendApplication | null;
}

const ApplyFriendPopup: React.FC<ApplyFriendPopupProps> = React.memo(
  ({ userId, targetId, friendGroups: friendGroupsData, target, sentFriendApplication: sentFriendApplicationData, receivedFriendApplication: receivedFriendApplicationData }) => {
    // Hooks
