...
const ChannelTab: React.FC<ChannelTabProps> = React.memo(
  ({ user, friends, server, serverOnlineMembers, channel, permissionOverride = 0, expanded, selectedItemId, setExpanded, setSelectedItemId }) => {
    // Hooks
    ...
    const permissionLevel = useMemo(
      () => Math.max(globalPermissionLevel, serverPermissionLevel, channelPermissionLevel, permissionOverride),
      [globalPermissionLevel, serverPermissionLevel, channelPermissionLevel, permissionOverride],
    );
