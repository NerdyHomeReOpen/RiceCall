...
export default function(){
    ...
    PostRouters.addRoute('/refresh/friendApplication', RefreshFriendApplicationHandler);
    ...
    PostRouters.addRoute('/refresh/memberApplication', RefreshMemberApplicationHandler);
    ...
    PostRouters.addRoute('/refresh/serverMemberApplications', RefreshServerMemberApplicationsHandler);
    ...
    PostRouters.addRoute('/refresh/userFriendApplications', RefreshUserFriendApplicationsHandler);
    PostRouters.addRoute('/refresh/userFriendGroups', RefreshUserFriendGroupsHandler);
