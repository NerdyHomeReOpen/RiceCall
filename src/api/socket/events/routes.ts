...
import { SendDirectMessageHandler, SendMessageHandler, ShakeWindowHandler } from "./message/message.handler";
import { RTCAnswerHandler, RTCCandidateHandler, RTCOfferHandler } from "./rtc/rtc.handler";
import { ConnectServerHandler, CreateServerHandler, DisconnectServerHandler, FavoriteServerHandler, SearchServerHandler, UpdateServerHandler } from "./server/server.handler";
...
export default function(eventRouter: EventRouters) {
    ...
    eventRouter.addRoute('createMemberApplication',CreateMemberApplicationHandler);
    eventRouter.addRoute('updateMemberApplication',UpdateMemberApplicationHandler);
    eventRouter.addRoute('deleteMemberApplication',DeleteMemberApplicationHandler);
