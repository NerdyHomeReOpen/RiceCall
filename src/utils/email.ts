...
<body class="body" style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; background-image: none; background-position: top left; background-size: auto; background-repeat: no-repeat;">
		<tbody>
			<tr>
				<td>
					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0073c6;">
						<tbody>
							<tr>
								<td>
														...
														<tr>
															<td class="pad" style="padding-bottom:15px;padding-top:15px;width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 226px;"><img src="https://2e81e64760.imgdist.com/pub/bfra/8f7sbmi7/xb3/8pu/2o3/login_logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="226" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:0.7;text-align:left;mso-line-height-alt:11px;">
																	...
																	<p style="margin: 0;">請點擊以下連結重設您的密碼：</p>
																</div>
															</td>
														</tr>
													</table>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top;">
													<table class="button_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<div class="alignment" align="center"><a href="${resetLink}" target="_blank" style="color:#ffffff;text-decoration:none;"><!--[if mso]>
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="${resetLink}"  style="height:52px;width:174px;v-text-anchor:middle;" arcsize="8%" fillcolor="#0073c6">
<v:stroke dashstyle="Solid" weight="0px" color="#0073c6"/>
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#ffffff;font-family:sans-serif;font-size:15px">
<![endif]--><span class="button" style="background-color: #0073c6; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #ffffff; display: inline-block; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 15px; font-weight: 400; mso-border-alt: none; padding-bottom: 10px; padding-top: 10px; padding-left: 55px; padding-right: 55px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span style="word-break: break-word; line-height: 30px;">重設密碼</span></span><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></a></div>
															</td>
														</tr>
													</table>
												</td>
													...
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="color:#000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:0.7;text-align:left;mso-line-height-alt:11px;">
																	<p style="margin: 0; margin-bottom: 12px;">&nbsp;</p>
																	<p style="margin: 0; margin-bottom: 12px;">如果您沒有發出此請求，請忽略此電子郵件。</p>
																	<p style="margin: 0; margin-bottom: 12px;">&nbsp;</p>
																	<p style="margin: 0; margin-bottom: 12px;">此致，</p>
																	<p style="margin: 0;">RiceCall 團隊</p>
																</div>
															</td>
														</tr>
													</table>
					...
					<table class="row row-6" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f4f4f5;">
						<tbody>
							<tr>
								<td>
									<table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-radius: 0; color: #000000; width: 480px; margin: 0 auto;" width="480">
														...
														<tr>
															<td class="pad">
																<div style="color:#444a5b;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:14px;">
																	<p style="margin: 0;">如果您在點擊「重設密碼」按鈕時遇到問題，請嘗試使用以下連結：<br><a href="${resetLink}" target="_blank" style="text-decoration: underline; color: #0073c6;" rel="noopener">${resetLink}</a></p>
																</div>
															</td>
														</tr>
													</table>
