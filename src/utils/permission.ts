...
export const isChannelMod = (permissionCode: number, orHigher: boolean = true) => (orHigher ? permissionCode >= 3 : permissionCode === 3);

export const isChannelAdmin = (permissionCode: number, orHigher: boolean = true) => (orHigher ? permissionCode >= 4 : permissionCode === 4);
