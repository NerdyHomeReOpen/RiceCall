...
/**
 * Calculate the luminance of a Linear RGB color
 * @param rLin - The red component of the Linear RGB color
 * @param gLin - The green component of the Linear RGB color
 * @param bLin - The blue component of the Linear RGB color
 * @returns The luminance of the Linear RGB color
 */
function luminance(rLin: number, gLin: number, bLin: number): number {
...
/**
 * Check if the color is too white (contrast is too low)
 * @param rgb - The color
 * @param minContrast - The minimum contrast
 * @returns Whether the color is too white
 */
 ...
 * @param rgb - The color
 * @param minContrast - The minimum contrast
 * @returns The color, contrast, and whether the color was changed
 */
