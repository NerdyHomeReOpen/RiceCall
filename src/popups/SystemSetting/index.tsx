    ...
    <div className="popup-wrapper">
      <div className="popup-body">
        ...
        <div className="popup-content" style={activeTabIndex === 0 ? {} : { display: 'none' }}>
          <div className="col">
            ...
            <div className={`input-box row disabled`}>
              ...
              <div className="label">{t('status-auto-dnd-label') + ' ' + t('soon')}</div>
            </div>
            <div className="label-header">
              <div className="label">{t('channel-setting')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('channel-ui-mode-classic-label')}</div>
            </div>
            <div className="input-box row">
            ...
            <div className="row">
              ...
              <div className="input-box col">
                <div className="label">{t('font-size')}</div>
        ...
        <div className="popup-content" style={activeTabIndex === 1 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="label-header">
              <div className="label">{t('audio-setting')}</div>
            </div>
            <div className="input-box col">
              <div className="label">{t('input-device')}</div>
              <div className="select-box" style={{ width: '100%', minWidth: '0' }}>
            ...
            <div className="input-box col">
              <div className="label">{t('output-device')}</div>
              <div className="select-box" style={{ width: '100%', minWidth: '0' }}>
            ...
            <div className="label-header">
              <div className="label">{t('record-setting')}</div>
            </div>
            <div className="input-box col">
              <div className="label">{t('record-format')}</div>
              <div className="select-box">
              ...
              <div className="input-box col">
                <div className="label">{t('record-save-path')}</div>
                <div className="row">
                  <input name="record-save-path" type="text" value={systemSettings.recordSavePath} style={{ maxWidth: '300px' }} readOnly />
                  <button className="button" onClick={handleRecordSavePathSelectBtnClick}>
            ...
            <div className="input-box row">
              ...
              <div className="label">{t('noise-cancellation-label')}</div>
            </div>
            <div className="input-box row">
        ...
        <div className="popup-content" style={activeTabIndex === 2 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="label-header">
              <div className="label">{t('default-speaking-mode')}</div>
            </div>
            <div className="input-box row">
            ...
            {systemSettings.speakingMode == 'key' && (
              <>
                <div key={'speakingKey'} className="input-box">
                  <input
                    name="speaking-key"
                    type="text"
                    ...
                    readOnly
                  />
                  {inputFocus === 'speakingKey' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
                </div>
                <div className="label">{t('setting-speaking-key-description')}</div>
              </>
            )}
            <div className="input-box row">
        ...
        <div className="popup-content" style={activeTabIndex === 3 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="label-header">
              <div className="label">{t('anti-spam-setting')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('forbid-friend-applications-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('forbid-shake-messages-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('forbid-member-invitations-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('forbid-stranger-messages-label')}</div>
            </div>
            <div className="label-header">
              <div className="label">{t('privacy-setting')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('share-current-server-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('share-recent-servers-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('share-joined-servers-label')}</div>
            </div>
            <div className="input-box row">
              ...
              <div className="label">{t('share-favorite-servers-label')}</div>
            </div>
            <div className="label-header">
              <div className="label">{t('message-history-setting')}</div>
            </div>
            <div className="input-box row disabled">
              <input name="not-save-message-history" type="checkbox" checked={true} onChange={handleNotSaveMessageHistoryChange} />
              <div className="label">{t('not-save-message-history-label') + t('soon')}</div>
            </div>
          </div>
        </div>
        <div className="popup-content" style={activeTabIndex === 4 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="label-header">
              <div className="label">{t('hot-key-setting')}</div>
            </div>
            <div key={'openMainWindow'} className="input-box col">
              <div className="label">{t('hot-key-open-main-window-label')}</div>
              <input
                ref={inputRef}
                ...
                readOnly
              />
              {inputFocus === 'openMainWindow' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
            </div>
            <div key={'increaseVolume'} className="input-box col">
              <div className="label">{t('hot-key-increase-volume-label')}</div>
              <input
                ref={inputRef}
                ...
                readOnly
              />
              {inputFocus === 'increaseVolume' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
            </div>
            <div key={'decreaseVolume'} className="input-box col">
              <div className="label">{t('hot-key-decrease-volume-label')}</div>
              <input
                ref={inputRef}
                ...
                readOnly
              />
              {inputFocus === 'decreaseVolume' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
            </div>
            <div key={'toggleSpeaker'} className="input-box col">
              <div className="label">{t('hot-key-toggle-speaker-label')}</div>
              <input
                ref={inputRef}
                ...
                readOnly
              />
              {inputFocus === 'toggleSpeaker' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
            </div>
            <div key={'toggleMicrophone'} className="input-box col">
              <div className="label">{t('hot-key-toggle-microphone-label')}</div>
              <input
                ref={inputRef}
                ...
                readOnly
              />
              {inputFocus === 'toggleMicrophone' && conflicts.length > 0 && <div className="error">{t('set-hotkey-error', { '0': conflicts.join(',') })}</div>}
            </div>
          </div>
        </div>
        <div className="popup-content" style={activeTabIndex === 5 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="input-box row">
              ...
              <div className="label">{t('disable-all-sound-effect-label')}</div>
            </div>
            <div className="label-header">
              <div className="label">{t('sound-effect-setting')}</div>
            </div>
              ...
              <table style={{ height: '330px' }}>
                ...
                <tbody className="table">
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayEnterVoiceChannelSound} />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayLeaveVoiceChannelSound} />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayStartSpeakingSound} />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayStopSpeakingSound} />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayReceiveDirectMessageSound} />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className={styles['sound-effect-preview-button']} onClick={handlePlayReceiveChannelMessageSound} />
                    </td>
        ...
        <div className="popup-content" style={activeTabIndex === 6 ? {} : { display: 'none' }}>
          <div className="col">
            <div className="label-header">
              <div className="label">{t('update-setting')}</div>
            </div>
            <div className="row">
              <div className="input-box row">
                ...
                <div className="label">{t('auto-check-for-updates-label')}</div>
              </div>
              <div className="button" onClick={handleCheckForUpdatesBtnClick}>
                {t('check-for-updates')}
              </div>
            </div>
            <div className="row">
              <div className="input-box col">
                <div className="label">{t('update-channel-label')}</div>
              ...
              <div className="input-box col">
                <div className="label">{t('update-check-interval-label')}</div>
                <div className="input-box row">
                  ...
                  <div className="label">{t('minute')}</div>
                </div>
              </div>
            </div>
          </div>
