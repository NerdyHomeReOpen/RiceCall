...
const EditSection: React.FC<EditSectionProps> = React.memo(({ server, applicationDesc, onServerNameLinkClick, onApplicationDescChange, onSubmitBtnClick, onCancelBtnClick }) => {
